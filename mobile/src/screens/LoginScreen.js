  ...
  return (
    ...
    >
      <View style={styles.hero}>
        ...
        <Text style={styles.titulo}>Bolão da Copa do Mundo Arianjo</Text>
        <Text style={styles.sub}>Entre para registrar seus palpites.</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.botao} onPress={onEntrar} disabled={carregando}>
          {carregando ? (
